...
/**
 * @author danie
 * Uscito fuori con alt+shift+j
 * 
 * Altri comandi interessanti sono:
 * ctrl+shift+ / oppure * oppure - oppure + (minimizza, massimizza TUTTE le linee di codice, cambia dimensioni font
 * ctrl+ - oppure + (minimizza o massimizza linee di codice)
 */
